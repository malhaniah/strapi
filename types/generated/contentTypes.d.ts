...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A portfolio case study.';
  ...
  attributes: {
    constraints: Schema.Attribute.Blocks &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    decisions: Schema.Attribute.Component<'sections.decision', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    retrospective: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bullets: Schema.Attribute.Component<'sections.bullet', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide identity, contact details, and navigation labels.';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
  ...
  attributes: {
    ...
    navWork: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Home page hero and capabilities.';
    displayName: 'Home';
    pluralName: 'homes';
    singularName: 'home';
  };
  ...
  attributes: {
    capabilities: Schema.Attribute.Component<'sections.capability', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
